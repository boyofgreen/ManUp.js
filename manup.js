...
var validMetaValues = [{ name: 'mobile-web-app-capable', manifestName: 'display' }, { name: 'apple-mobile-web-app-capable', manifestName: 'display' }, { name: 'apple-mobile-web-app-title', manifestName: 'short_name' }, { name: 'application-name', manifestName: 'short_name' }, { name: 'msapplication-TileColor', manifestName: 'ms_TileColor' }, { name: 'msapplication-square70x70logo', manifestName: 'icons', imageSize: '70x70' }, { name: 'msapplication-square150x150logo', manifestName: 'icons', imageSize: '150x150' },{ name: 'msapplication-square150x150logo', manifestName: 'icons', imageSize: '128x128' },{ name: 'msapplication-square150x150logo', manifestName: 'icons', imageSize: '450x450' },{ name: 'msapplication-square150x150logo', manifestName: 'icons', imageSize: '558x270' },{ name: 'msapplication-square150x150logo', manifestName: 'icons', imageSize: '1270x270' }];
